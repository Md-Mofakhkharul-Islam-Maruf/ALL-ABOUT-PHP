...
<html>
	...
	<body>
		<div class="structure">
			...
			<section class="main">
				<?php
					echo"URL EMAIL VALIDATION:<br><br>";
					...
					if($_SERVER["REQUEST_METHOD"]== "POST"){
						...
						{
							$erroremail= "<span style= 'color: red'>Invalide email formate</span>";
						}
						else{
						...
						{
							$errorwebsite= "<span style= 'color: red'>Invalide website formate</span>";
						}
						else{
				...
				<form action="" method="post">
					<table>
						...
						<tr>
							<td>Email:</td>
							<td><input type="text" name="email"><?php echo $erroremail, $email; ?></td>
						</tr>
						
						<tr>
							<td>website:</td>
							<td><input type="text" name="website"><?php echo $errorwebsite, $website; ?></td>
						</tr>
